...
```c
#include <em_driver/atk_ms53l1m/atk_ms53l1m.h>
```
...
em.add_libs(target, "em_driver", {
    atk_ms53l1m = {
        mode = "extern",
        port = {path.join(os.scriptdir(), "board", "port_atk_ms53l1m.c")}
    }
})
```
...
- 清单：`src/em_driver/atk_ms53l1m/atk_ms53l1m.lua`
- 源码目录：`src/em_driver/atk_ms53l1m/`
